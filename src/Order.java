...
class NewwFrame extends JFrame{
    ...
    private JRadioButton dish1, dish2, dish3, dish4, dish5, dish6;
    ...
    public NewwFrame(){
        ...
        dish1 = new JRadioButton(getdish());
        dish2 = new JRadioButton(getdish());
        dish3 = new JRadioButton(getdish());
        dish4 = new JRadioButton(getdish());
        dish5 = new JRadioButton(getdish());
        dish6 = new JRadioButton(getdish());
        //dish1.setbounds(200,300,20,20);
