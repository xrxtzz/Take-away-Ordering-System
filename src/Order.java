...
class NewwFrame extends JFrame{
    ...
    private JButton getButtonlogin(){
        if(login==null){
            ...
            login.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return login;
    }
    private JButton getButtonsignin(){
        if(signin==null){
            ...
            signin.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return signin;
    }
    private JButton getButtonmyorders(){
        if(myorders==null){
            ...
            myorders.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return myorders;
    }
    private JButton getButtonprev(){
        if(prev==null){
            ...
            prev.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return prev;
    }
    private JButton getButtonnext(){
        if(next==null){
            ...
            next.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return next;
    }
    private JButton getButtonordernow(){
        if(ordernow==null){
            ...
            ordernow.addActionListener(new nowClick());//添加监听器类，其主要的响应都由监听器类的方法实现
        }
        return ordernow;
    }
